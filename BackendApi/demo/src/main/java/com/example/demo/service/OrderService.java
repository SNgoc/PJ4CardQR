...
public class OrderService {
    ...
    public String create(CreateOrderRequest createOrderRequest) throws IOException, WriterException, MessagingException {
        ...
        if(productRepository.existsByUser(user)){
            ...
            product = new Product("Description",user.getFullname(),user.getLinkImage(),"http://localhost:8081/Display/"+user.getUsername(),url,user, new Date(),0, createOrderRequest.getYear(), token);
        }
    ...
    private String buildEmail(String name, String link) {
        return
                "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                        ...
                        "        \n" +
                        "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + name + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> Thank you for signing up for our service. Please wait for the administrator to check, please wait a moment. </p>" +
                        "        \n" +
                        "      </td>\n" +
                        "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                        "    </tr>\n" +
