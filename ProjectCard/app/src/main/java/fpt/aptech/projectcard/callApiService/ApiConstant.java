...
public class ApiConstant {
    ...
    //for api backend
    public static final String BASE_URL = "http://192.168.1.146:8080";//for same ip wifi, to test api intellij phone replace localhost
    //for client show web front end use on mobile and pc together
    public static final String BASE_URL_CLIENT = "http://192.168.1.146:8081";//test only on Ngoc's pc
