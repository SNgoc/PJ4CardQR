...
public class IndexControllers {
    ...
    @GetMapping("/")
    public String index(HttpSession session,Model model, RedirectAttributes attributes ,
                        @RequestParam(value = "month",defaultValue = "",required = false) Long month ,
                        @RequestParam(value = "year",defaultValue = "",required = false) String year,@RequestParam(value = "chart",defaultValue = "",required = false) Long categoryId) throws IOException, InterruptedException {
        ...
        if (categoryId != null){
            ...
            assert charts != null;
            for (Chart c : charts){
                data.put("Month "  + c.getMonth()+ "  Year " + c.getYear(),c.getPrice());
            ...
            assert charts != null;
            for (Chart c : charts){
                data.put("Day "  + c.getDay()+ "  Year " + c.getYear(),c.getPrice());
       ...
       data.entrySet().forEach(System.out::println);
            ...
            assert charts != null;
            for (Chart c : charts){
                dataYear.put("Month "  + c.getMonth()  + "  Year " + c.getYear(),c.getPrice());
