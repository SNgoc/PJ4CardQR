...
public class LoginController {
    ...
    @GetMapping("/Profile")
    public String Profile(Model model,HttpSession session) throws IOException, InterruptedException {
        model.addAttribute("users", userService.userProfile(session));
    ...
    public String changeImageProfile(HttpSession session, Model model
        ...
        var user = userService.userProfile(session);
        session.setAttribute("linkImage",user.getLinkImage());
